...
abstract class $TagsModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Tag> items, int total, int limit, int offset});
}
...
class _$TagsModelImpl implements _TagsModel {
  ...
  @override
  String toString() {
    return 'TagsModel(items: $items, total: $total, limit: $limit, offset: $offset)';
  }
...
abstract class _TagsModel implements TagsModel {
  const factory _TagsModel(
      ...
      required final int offset}) = _$TagsModelImpl;
